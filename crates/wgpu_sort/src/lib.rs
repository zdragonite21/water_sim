...
/// TODO describe me
const RS_HISTOGRAM_BLOCK_ROWS: u32 = 14;
...
impl GPUSorter {
    ...
    fn record_calculate_histogram_indirect(
    ...
    ) {
        {
            ...
            pass.push_debug_group("Water SPH / radix sort / zero histogram indirect");
            pass.set_pipeline(&self.zero_p);
            pass.set_bind_group(0, bind_group, &[]);
...

        {
            ...
            pass.push_debug_group("Water SPH / radix sort / histogram indirect");
            pass.set_pipeline(&self.histogram_p);
            pass.set_bind_group(0, bind_group, &[]);
            pass.dispatch_workgroups_indirect(dispatch_buffer, 0);
            pass.pop_debug_group();
    ...
    fn record_scatter_keys_indirect(
        ...
        pass.set_bind_group(0, bind_group, &[]);
        pass.push_debug_group("Water SPH / radix sort / scatter even 0 indirect");
        pass.set_pipeline(&self.scatter_even_p);
        pass.dispatch_workgroups_indirect(dispatch_buffer, 0);
        pass.pop_debug_group();

        pass.push_debug_group("Water SPH / radix sort / scatter odd 0 indirect");
        pass.set_pipeline(&self.scatter_odd_p);
        pass.dispatch_workgroups_indirect(dispatch_buffer, 0);
        pass.pop_debug_group();

        pass.push_debug_group("Water SPH / radix sort / scatter even 1 indirect");
        pass.set_pipeline(&self.scatter_even_p);
        pass.dispatch_workgroups_indirect(dispatch_buffer, 0);
        pass.pop_debug_group();

        pass.push_debug_group("Water SPH / radix sort / scatter odd 1 indirect");
        pass.set_pipeline(&self.scatter_odd_p);
        pass.dispatch_workgroups_indirect(dispatch_buffer, 0);
        pass.pop_debug_group();
    }
